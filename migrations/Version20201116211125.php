 ...
 */
final class Version20201116211125 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE warning (id INT NOT NULL, warning TEXT CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_general_ci`, Bitcoin_Address TEXT CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_general_ci`, Email TEXT CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_general_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
